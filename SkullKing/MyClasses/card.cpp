...
const QSize Card::scale = QSize(106, 148);
...
QPixmap Card::pixmap()
{
    if (Name == Cards::Queen || Name == Cards::SkullKing || Name == Cards::Pirate)
    {
        string pix_name = ":/Pictures/Cards/" + from_Cards_to_string(Name) + ".png";
        if (pix_map.load(pix_name.c_str()))
        {
            pix_map = pix_map.scaled(scale, Qt::IgnoreAspectRatio);
            qDebug() << from_Cards_to_string(Name).c_str() << "is loaded successfully";
        }
        else
        {
            qDebug() << from_Cards_to_string(Name).c_str() << "is loaded successfully";
    ...
    {
        string pix_name = ":/Pictures/Cards/" + from_Cards_to_string(Name) + to_string(Number) + ".png";
        if (pix_map.load(pix_name.c_str()))
        {
            pix_map = pix_map.scaled(scale, Qt::IgnoreAspectRatio);
            qDebug() << from_Cards_to_string(Name).c_str() << "is loaded successfully";
        ...
        {
            qDebug() << from_Cards_to_string(Name).c_str() << "is not loaded successfully";
        }
    }
    return pix_map;
}
...
QPalette Card::palette()
{
    QPalette pal;
    pal.setBrush(QPalette::Button, this->pixmap());
    return pal;
}

// void Card::load_pixmap()
// {
//     if (Name == Cards::Queen || Name == Cards::SkullKing || Name == Cards::Pirate)
//     {
//         string pix_name = ":/Pictures/Cards/" + from_Cards_to_string(Name) + ".png";
...
//         if (pix_map.load(pix_name.c_str()))
//         {
//             pixmap_size = pix_map.scaled(scale).size();
//             qDebug() << from_Cards_to_string(Name).c_str() << "is loaded successfully";
//         }
//         else
//         {
...
//         }
//     }
//     // pix_item = new QGraphicsPixmapItem(pix_map.scaled(scale, Qt::KeepAspectRatio));
// }

// QGraphicsPixmapItem *Card::pixmap_item()
// {
//     return pix_item;
// }
...
// {
//     in >> card.Name >> card.Number >> card.deleted;
//     return in;
// }